...
from keras.layers import Dense, GlobalAveragePooling2D, Input, Conv2D, MaxPool2D, Flatten, Dropout, BatchNormalization, SeparableConv2D
...
#Couche définissant l'input du réseau
